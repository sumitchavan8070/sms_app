...
class AppColors {
  ...
  static const venus = Color(0xFF8C8989);
  static const grey = Color(0xFF939393);
  static const startDust = Color(0xFF9A9EA4);
  ...
  static const Color sapGreen = Color(0xFF538B19);
  ...
  static const Color gainsBoroAlt = Color(0xFFDDDDDD);
  ...
  static const artyClickRed = Color(0xFFFF0000);
  ...
  static const chalky = Color(0xFFF4D895);
  static const ochre = Color(0xFFC58A00);

  static const fallLeafBrown = Color(0xFFD2B35E);
  ...
  static const Color primaryColor = Color(0xFFC7BBF3);

  // TODO: primary color for the pte app
  // static const Color primaryColor = Color(0xFF027FA2);
  ...
  static const strawberry = Color(0xFFFF2D46);
}
